...
local Window = Fluent:CreateWindow({
    Title = "Ân Hub",
    SubTitle = "by Ân |https://discord.gg/ZS5utmbWSW",
    TabWidth = 160,
...
local Tabs = {
    ...
    Stats = Window:AddTab({ Title = "Nâng K.Nghiệm", Icon = "plus-circle" }),
...
--Create Tabs
    ...
    local ToggleAutoFarmLevel = Tabs.Main:AddToggle("ToggleAutoFarmLevel", {Title = "Tự Farm Level", Default = false })
...
local ToggleBone = Tabs.Main:AddToggle("ToggleBone", {Title = "Tự Nâng Xương", Default = false })
...
spawn(function()
    ...
    local ToggleMaterial = Tabs.Main:AddToggle("ToggleMaterial", {Title = "Tự Farm Tài Nguyên", Default = false })
...
if Third_Sea then
    ...
    local ToggleBoat = Tabs.Main:AddToggle("ToggleBoat", {Title = "Tự Mua Thuyền", Default = false })
   ...
   ToggleTW:OnChanged(function(Value)
    ...
    local ToggleTerrorshark = Tabs.Main:AddToggle("ToggleTerrorshark", {Title = "Tự Đánh Cá", Default = false })
...
local ToggleMirage = Tabs.Main:AddToggle("ToggleMirage", {Title = "Tự Mirage Đảo", Default = false })
...
local ToggleRemove = Tabs.Setting:AddToggle("ToggleRemove", {Title = "Xóa Dòng Chữ Sát Thương", Default = true })
...
--------------------------------------------------------------------------------------------------------------------------------------------
--Stats
local ToggleMelee = Tabs.Stats:AddToggle("ToggleMelee", {Title = "Tự Nâng Melee/Năng Lượng", Default = false })
...
local ToggleDe = Tabs.Stats:AddToggle("ToggleDe", {Title = "Tự Nâng Thanh Máu", Default = false })
...
local ToggleSword = Tabs.Stats:AddToggle("ToggleSword", {Title = "Tự Nâng Kiếm", Default = false })
...
local ToggleGun = Tabs.Stats:AddToggle("ToggleGun", {Title = "Tự Nâng Súng", Default = false })
...
local ToggleFruit = Tabs.Stats:AddToggle("ToggleFruit", {Title = "Tự Nâng TRái Ác Quỷ", Default = false })
...
Tabs.Player:AddButton({
    Title = "Làm Lại Danh Sách Người Chơi",
    Description = "Làm Lại Danh Sách Người Chơi",
    Callback = function()
        Playerslist = {}
        SelectedPly:Clear()
        for i,v in pairs(game:GetService("Players"):GetChildren()) do  
...
local ToggleFruit = Tabs.Fruit:AddToggle("ToggleFruit", {Title = "Mua Trái Đc Chọn", Default = false })
ToggleFruit:OnChanged(function(Value)
